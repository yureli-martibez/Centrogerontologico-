              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
                    <div class="img-box">
                      <div>
                        <img src="images/centro1.jpg" alt="" class="" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="detail-box">
                      <div>
                        ...
                        <p>
                          El centro gerontológico es un lugar que acoge y cuida a las personas 
                          de la tercera edad como si estuvieran en su hogar.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
                    <div class="img-box">
                      <div>
                        <img src="images/centro3.jpg" alt="" class="" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="detail-box">
                      <div>
                        <h1>
                          Apoyo integral <br>
                          para un envejecimiento <br>
                          <span>
                            Saludable.
                          </span>
                        </h1>
                        <p>
                          La misión del centro gerontológico de proporcionar un enfoque 
                          integral en el cuidado de los adultos mayores.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
                    <div class="img-box">
                      <div>
                        <img src="images/centro7.jpg" alt="" class="" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="detail-box">
                      <div>
                        ...
                        <p>
                          El centro gerontológico es más que un lugar de cuidado,
                           es un hogar donde los residentes pueden sentirse cómodos, seguros y atendidos.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div class="service_container ">
          <div class="row">
            <div class="col-md-3">
              <div class="box b-1">
                <div class="img-box">
                  <img src="images/instalaciones1.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h6>
            ...
            <div class="col-md-3">
              <div class="box b-4">
                <div class="img-box">
                  <img src="images/instalaciones2.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h6>
            ...
            <div class="col-md-3">
              <div class="box b-1">
                <div class="img-box">
                  <img src="images/instalaciones3.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h6>
            ...
            <div class="col-md-3">
              <div class="box b-4">
                <div class="img-box">
                  <img src="images/instalaciones4.jpg" alt="">
                </div>
                <div class="detail-box">
                  <h6>
