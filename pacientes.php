...
// Realiza una consulta para obtener los registros de pacientes
$conexion = conn();
if (!$conexion) {
...
if ($resultado->num_rows > 0) {
    ...
    echo "<a class='btn btn-dark' href='PDFpacientes.php"."'>Descargar PDF</a>";
    echo "<thead><tr><th>Nombre</th><th>Apellido</th><th>Correo</th><th>Teléfono</th><th>Domicilio</th><th>Fecha de Nacimiento</th><th>Tutor</th><th>Acciones</th></tr></thead>";
    echo "<tbody>";
    while ($fila = $resultado->fetch_assoc()) {
        ...
        echo "<td>" . $fila["Pers_contact"] . "</td>";
        echo "<td>";
        echo "<a class='btn btn-secondary' href='editar.php?id=" . $fila["id_paciente"] . "'>Editar</a> ";
        echo "<a class='btn btn-secondary' href='eliminar.php?id=" . $fila["id_paciente"] . "'>Eliminar</a>";
        echo "</td>";
        echo "</tr>";
